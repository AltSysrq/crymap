...
Disposition: Item stream CRDT is complex and efficient, but the security of
bitsets is so flimsy it doesn't feel like a good option.
...
COMPRESS [RFC 4978] would be nice, but it's welded to STARTTLS. We might be
able to do the same thing in our TLS termination though.
