...
- An encryption block, giving any information needed to descrypt the message
...
The user's password is passed through Scrypt, using parameters and salt stored
